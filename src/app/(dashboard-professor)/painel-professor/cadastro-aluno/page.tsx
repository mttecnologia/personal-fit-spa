    ...
    return (
        <div>
            <div className="border-b border-zinc-200 pb-4">
                <h1 className="text-3xl font-bold tracking-tighter">Cadastro do Aluno</h1>
            </div>
            <form action="" id="setting" className="mt-6 flex flex-col w-full gap-5 divide-y divide-zinc-300">
                <div className="grid gap-3 grid-cols-form">
                    <label htmlFor="firstName" className="text-sm font-medium text-zinc-700">
                        Nome e Sobrenome
                        <span className="mt-0.5 text-sm font-normal text-zinc-500 block">digite o nome no primeiro campo e no segundo o sobrenome </span>
                    </label>
                ...
                <div className="grid gap-3 grid-cols-form pt-5">
                    <label htmlFor="email" className="text-sm font-medium text-zinc-700 ">
                        Foto do aluno
                        <span className="mt-0.5 text-sm font-normal text-zinc-500 block">Isso será exibido no perfil do aluno</span>
                    </label>
                ...
                <div className="grid gap-3 grid-cols-form pt-5">
                    <label htmlFor="role" className="text-sm font-medium text-zinc-700">
                        ...
                        <span className="mt-0.5 text-sm font-normal text-zinc-500 block">As informações são essenciais para o fluxo do sistema</span>
                    </label>
                    <div className="grid gap-6 grid-cols-2">
                        <InputRoot>
                            <InputRootInside>
                ...
                <div className="flex justify-end gap-2 pt-4">
                    <Link href="/painel-professor" className="border border-zinc-200 hover:bg-zinc-100 text-black text-sm flex gap-2 items-center justify-center  font-semibold rounded-lg py-2 px-4 ">Cancel</Link>
